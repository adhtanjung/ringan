					...
					<Table>
						<TableHeader class="sticky top-0 z-10 bg-background shadow-sm">
							<TableRow class="hover:bg-transparent border-b border-border">
								...
								<TableHead class="w-[50px] px-2 sticky right-0 z-20 bg-background shadow-[inset_1px_0_0_0_hsl(var(--border))]"></TableHead>
							</TableRow>
						</TableHeader>
						...
						<TableBody>
							<template v-if="loading">
								<TableRow v-for="i in 10" :key="i">
									...
									<TableCell class="p-2 sticky right-0 z-10 bg-background shadow-[inset_1px_0_0_0_hsl(var(--border))]"
										><Skeleton class="h-4 w-4"
									/></TableCell>
								</TableRow>
							</template>
							...
							<TableRow
								...
								:key="item.id || index"
								class="group h-10 border-b border-border hover:bg-muted/50 data-[state=selected]:bg-muted"
							...
							>
								...
								<TableCell class="p-2 text-right sticky right-0 z-10 bg-background group-hover:bg-muted/50 data-[state=selected]:bg-muted shadow-[inset_1px_0_0_0_hsl(var(--border))]">
									<DropdownMenu>
										<DropdownMenuTrigger as-child>
											<Button
												variant="ghost"
